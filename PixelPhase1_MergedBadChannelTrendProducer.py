...
trendBPIXL4.GetYaxis().SetTitle("# of Bad Channels BPIXL4")
trendBPIX.GetYaxis().SetTitle("% of Bad Channels BPIX")
trendFPIXR1DM3.GetYaxis().SetTitle("% of Bad Channels FPIXR1DM3")
trendFPIXR1DM2.GetYaxis().SetTitle("% of Bad Channels FPIXR1DM2")
trendFPIXR1DM1.GetYaxis().SetTitle("% of Bad Channels FPIXR1DM1")
trendFPIXR1DP1.GetYaxis().SetTitle("% of Bad Channels FPIXR1DP1")
trendFPIXR1DP2.GetYaxis().SetTitle("% of Bad Channels FPIXR1DP2")
trendFPIXR1DP3.GetYaxis().SetTitle("% of Bad Channels FPIXR1DP3")
trendFPIXR2DM3.GetYaxis().SetTitle("% of Bad Channels FPIXR2DM3")
trendFPIXR2DM2.GetYaxis().SetTitle("% of Bad Channels FPIXR2DM2")
trendFPIXR2DM1.GetYaxis().SetTitle("% of Bad Channels FPIXR2DM1")
trendFPIXR2DP1.GetYaxis().SetTitle("% of Bad Channels FPIXR2DP1")
trendFPIXR2DP3.GetYaxis().SetTitle("% of Bad Channels FPIXR2DP2")
trendFPIXR2DP3.GetYaxis().SetTitle("% of Bad Channels FPIXR2DP3")
...
folder="/afs/cern.ch/user/c/cctrack/scratch0/AutomaticBadChannelsTrends"
