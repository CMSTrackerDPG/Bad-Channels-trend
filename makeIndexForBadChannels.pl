...
#    06-Apr-2016 Modification for the tracker DQM purpose on vocms061
#
#----------------------------------------------------------- 
$diow_version = '2.0';
...
#-----------------------------------------------
	...
	$string = "$prefix <td align=\"center\"> <a href=\"" . $annotatejpegfile . "\"><img src=\"" . $jpegfile . "\" height=\"150\" width=\"600\" hspace=\"5\" vspace=\"5\" border=\"0\" alt=\"$jpegfile\" /></a> \n  <br /> $annotatejpegfile </td> $suffix \n"; 
